...
// static Cord last_position = {0, 0};
// static Dir last_direction = Dir::UP;
// static int behavior_state = 0; // 0=patrol, 1=aggressive, 2=evade
// static int no_target_counter = 0;

// void npc2_init(IServer &server, Cord tile_cord) {
//     id = server.spawn_tank_in_tile(tile_cord);
// }

// void npc2_step(IServer &server) {
//     TankInfo info;
...
//                     action_cooldown = 3;
//                 } else if (action < 6) {
//                     server.tank_rotate(id, RotationDir::LEFT);
//                     action_cooldown = 2;
//                 } else if (action < 8) {
//                     server.tank_rotate(id, RotationDir::RIGHT);
//                     action_cooldown = 2;
//                 }
//                 break;
...
//                         RotationDir::LEFT : RotationDir::RIGHT);
//                     action_cooldown = 1;
